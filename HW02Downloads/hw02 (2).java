...
public class hw02 extends Application implements EventHandler<ActionEvent> {
   ...
   private Scene scene;
   boolean use = true;
   String[] errors = { "First name", "Last name", "Birth day", "Birth month", "Birth year", "Weight", "Height" };
   ...
   private void open(){
      ...
      try{
         ...
         Scanner scn = new Scanner(new FileReader(selectedFile));
         ...
         while (scn.hasNextLine()){
            ...
            if(counter!=0 && !line.trim().isEmpty()){
   ...
   private void read(){
      ...
      try{
         ...
         taData.appendText(String.format("%n%n%-20s %10s %8s %8s%n%n", "First & Last name", "Birthdate",
                        "Weight", "Height"));
         ...
         for(int i=0; i<usable; i++){
            ...
            taData.appendText(String.format("%-18s %12s %8d %8.1f%n", name, date, weight, height));
         }
         dis.close();
